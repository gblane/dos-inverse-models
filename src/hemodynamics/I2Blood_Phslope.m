function [dO, dD, dT, dmua] = I2Blood_Phslope(dis, PhPh, mua0Lam, musp0Lam, lambda, fmod, nin)
% I2Blood_Phslope Calculate hemoglobin changes from phase slope measurements.
%
% [dO, dD, dT, dmua] = I2Blood_Phslope(dis, PhPh, mua0Lam, musp0Lam, lambda, fmod, nin)
%
