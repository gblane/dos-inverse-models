function [dO, dD, dT, dmua] = I2Blood_SSPh(dis, PhPh, mua0Lam, musp0Lam, lambda, fmod, nin)
% I2Blood_SSPh Calculate hemoglobin changes from single-slope phase measurements.
%
